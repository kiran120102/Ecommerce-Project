...
public class UserService {
    ...
    public void initRoleAndUser() {
        ...
        User user = new User();
        user.setUserName("pallavi123");
        user.setUserPassword(getEncodedPassword("pallavi@123"));
        user.setUserFirstName("Pallavi");
        user.setUserLastName("Shintre");
        ...
        user.setUserPassword(getEncodedPassword("kiran@123"));
